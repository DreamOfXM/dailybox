  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        <SectionCard title="Video Compress" subtitle="MP4↔WebM，ffmpeg.wasm EN 720p/1M，lazy load">
          ...
          <div className="flex gap-3 mt-4">
            ...
            <button onClick={() => transcode("webm")} disabled={!file || busy} className="px-4 py-2 rounded-xl bg-white/[0.06] text-white text-sm disabled:opacity-40">To WebM</button>
          </div>
          ...
          <Hint>First transcode willDownload ffmpeg EN，EN；ENFilesEN 1 EN。</Hint>
        </SectionCard>
      </div>
    </div>
  );
